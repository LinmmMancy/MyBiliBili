...
import com.mancy.mybilibili.Adapter.ShoppingCartAdapter;
...
import com.mancy.mybilibili.pay.PayResult;
import com.mancy.mybilibili.pay.SignUtils;
...
import static com.mancy.mybilibili.pay.PayKeys.DEFAULT_SELLER;
import static com.mancy.mybilibili.pay.PayKeys.PRIVATE;
import static com.mancy.mybilibili.pay.PayKeys.PUBLIC;
...
public class ShopCarFragment extends BaseFragment {
    ...
    private List<ShopXiangqing> list;
    ...
    public static final String PARTNER = PRIVATE;
    //商户收款账号
    public static final String SELLER = DEFAULT_SELLER;
    //商户私钥，pkcs8格式
    ...
    public void initData() {
        ...
        adapter = new ShoppingCartAdapter(context, list, checkboxAll, checkboxDeleteAll, tvShopcartTotal);
        ...
        adapter.setOnItemClickListener(new ShoppingCartAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int postion) {
                ...
                ShopXiangqing shopXiangqing = adapter.data.get(postion);
                Log.e("TAG", "CartActivity onItemClick()" + shopXiangqing.getIscked());
                shopXiangqing.setIscked(!shopXiangqing.getIscked());
                Log.e("TAG", "CartActivity onItemClick()" + shopXiangqing.getIscked());
                //刷新选择状态
...
//                GoodsBean goodsBean = list.get(i);
                ShopXiangqing shopXiangqing = list.get(i);
...
//                Intent intent = new Intent(context, PaymentActivtiy.class);
...
//                Toast.makeText(context, "删除全选", Toast.LENGTH_SHORT).show();
