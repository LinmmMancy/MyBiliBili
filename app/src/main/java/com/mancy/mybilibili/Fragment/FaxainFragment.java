...
import com.mancy.mybilibili.view.activity.ShopActivity;
import com.mancy.mybilibili.bean.TagBean;
import com.mancy.mybilibili.view.actvityMvp.HuoDongActivity;
import com.mancy.mybilibili.view.activity.RankingActvitity;
...
public class FaxainFragment extends BaseFragment {
    ...
    private void initListener() {
        ...
        layoutOriginal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, RankingActvitity.class);
                startActivity(intent);
            }
        });
