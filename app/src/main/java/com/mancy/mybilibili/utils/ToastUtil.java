...
/**
 * 作者：Tronzzb on 2017/3/24 16:11.
 * 邮箱：278042465@qq.com
 */

public class ToastUtil {

    private static Context context = MyAppcation.getContext();// App生命周期中唯一Context，BaseApplication继承Application
    ...
    private static void showMsg(final int typeCode, final String msg) {
        ...
        if (handler == null) {
            handler = MyAppcation.getHandler();
        }
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                toast.setGravity(Gravity.BOTTOM | Gravity.FILL_HORIZONTAL, 0, 0);// toast显示位置
